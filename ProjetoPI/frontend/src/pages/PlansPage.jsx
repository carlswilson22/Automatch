      ...
      <section className="pt-16 pb-12 px-6 text-center relative overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-slate-400 font-light leading-relaxed mb-10">
            Tenha em mãos inteligência artificial para inspeção, confiança certificada pelo TrustScore™ e alcance milhares de compradores qualificados todos os dias.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition-all">
              ...
              <h3 className="text-xl font-bold text-white mb-2">TrustScore™ 0 a 100</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
                Carros com TrustScore certificado vendem em média 3.8x mais rápido porque eliminam a desconfiança de leilão, sinistro ou multas ocultas.
              </p>
            </div>
